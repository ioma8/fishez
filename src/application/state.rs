...
pub struct PanelState {
    ...
    pub directory_entry_lower_names: Vec<String>,
    pub entry_counts: (usize, usize),
    pub disk_usage: Option<(u64, u64)>,
    pub disk_usage_path: PathBuf,
    pub disk_usage_pending: bool,
    pub search_generation: u64,
    pub search_cancel: Option<Arc<AtomicBool>>,
    pub search_match_lines: HashMap<PathBuf, usize>,
    pub disk_usage_checked: Option<Instant>,
    pub cursor: usize,
    pub scroll: usize,
    pub mode: PanelMode,
    ...
    pub directory_cancel: Option<Arc<AtomicBool>>,
...
impl PanelState {
    ...
    pub fn new() -> Self {
        Self {
            ...
            directory_entry_lower_names: Vec::new(),
            entry_counts: (0, 0),
            disk_usage: None,
            disk_usage_path: PathBuf::new(),
            disk_usage_pending: false,
            search_generation: 0,
            search_cancel: None,
            search_match_lines: HashMap::new(),
            disk_usage_checked: None,
            cursor: 0,
            scroll: 0,
